...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        // then, define Enum class that implements Collection.SearchableProperty with properties
        ...
        // then, create an instance on Collection
        var collection = new Collection<Person>(PersonSearchableProperties.class);
